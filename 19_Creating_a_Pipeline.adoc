...
copy and paste the following Build Configuration.  Make sure to go through the text and replace *UserName* with your assigned username.  After double-checking your edits, click `Create`.
